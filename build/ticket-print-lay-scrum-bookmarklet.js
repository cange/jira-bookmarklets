javascript:void(function(){var Namespace = function(a) {
    ...
    return {
        create: function(b) {
            for (var c, d = a, e = b.split("."), f = e.length, g = 0; f > g; g++) c = e[g], 
            d = d[c] = d[c] || {};
        },
        is: function(b, c) {
            var d, e, f, g = a, h = !1, i = 0;
            for ("object" == typeof b ? g = b : c = b, e = c.split("."), d = e.length; d > i; i++) {
                if (f = e[i], !g[f]) return h = !1, !1;
                g = g[f], h = !0;
            }
            return h;
        }
...
String.prototype.truncate = function(a) {
    ...
    return b > a && (e = this.substr(0, a - d) + c), e;
}, String.prototype.trimWhitespace = function() {
    "use strict";
    return this.replace(/\s+/g, " ").split(/\n/).join(" ");
}, String.prototype.toArray = function(a) {
    "use strict";
    return a = new RegExp(a || ","), this.split(a);
}, Namespace.create("xing.core.helpers"), xing.core.helpers.isArray = function(a) {
    "use strict";
    return "[object Array]" === Object.prototype.toString.call(a);
}, xing.core.helpers.isObject = function(a) {
    "use strict";
    return "[object Object]" === Object.prototype.toString.call(a);
}, Namespace.create("xing.core"), xing.core.I18n = function() {
    "use strict";
    this.en = {
        messages: {
            ticketCached: {
...
}, Namespace.create("xing.core"), xing.core.Markup = function() {
    "use strict";
    var a = this;
...
}, Namespace.create("xing.core"), xing.core.Observer = function() {
    "use strict";
    var a = this;
    a._observers = [], a.subscribe = function(b) {
        a._observers.push(b);
    }, a.unsubscribe = function(b) {
        var c = a.observer.indexOf(b);
        c >= 0 && a._observers.splice(c);
    }, a.update = function() {
        a._observers.forEach(function(a) {
            a.update();
        });
    };
}, Namespace.create("xing.core"), xing.core.Presenter = function() {
    "use strict";
    var a = this;
    a.dashalizer = function(a) {
        ...
        var b, c, d, e, f = "";
        return a && (b = new Date(a), c = b.getMonth() + 1, c = c > 9 ? c : "0" + c, d = b.getFullYear(), 
        e = b.getDate(), f = d + "-" + c + "-" + e), f;
...
}, Namespace.create("xing.core.table"), xing.core.table.Builder = function() {
    "use strict";
    var a = this;
    a._text = function(a) {
        ...
        b = " " + (b || "");
        var c, d = a.options || {}, e = "cssClass" in d ? d.cssClass : "", f = "";
        $.extend(d, {
            cssClass: e + b
        }), " " === d.cssClass && delete d.cssClass;
        for (c in d) {
            var g = "cssClass" === c ? "class" : c, h = d[c] || "";
            g = g.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(), f += " " + g + '="' + h + '"';
        }
        return f;
    }, a.row = function(b) {
        var c = "";
        ...
        return d += a._cellTitle(c), d += a._cellBody(c), "<" + e + a._addCssClass(c) + '><div class="gm-inner">' + d + "</div></" + e + ">";
        ...
        return b.forEach(function(b) {
            d += a.row(b);
        }), '<table class="gm-table' + e + '">' + d + "</table>";
    };
}, Namespace.create("xing.core.table"), xing.core.table.layout = {
    ...
    c = c || e.DEFAULT_LAYOUT, d._mapSwitch = function(c, e) {
        var f;
        if ("string" == typeof e) f = a[e]({
            data: c,
            local: b.ticket
        }); else if (xing.core.helpers.isObject(e)) {
            var g = Object.keys(e)[0];
            e[g].maxLength && (c[g] = c[g].truncate(e[g].maxLength)), f = a[g]({
                data: c,
                local: b.ticket
            });
        } else f = d.build(c, e);
        ...
        b = b || e.get(c);
        for (var f = [], g = 0, h = b.length; h > g; g++) f[g] = d._mapSwitch(a, b[g]);
        return f;
    };
}, Namespace.create("xing.core"), xing.core.TicketCache = function(a) {
    "use strict";
    var b = this, c = location.hostname, d = c ? "." : "local.";
    b.STORAGE_KEY = c + d + "ticket", b.DEFAULT_COLLABORATOR_KEY = c + d + "default_collaborators", 
    b.default = {
        collaborators: localStorage.getItem(b.DEFAULT_COLLABORATOR_KEY) || ""
    }, b.data = {}, b.latest = {}, b.update = function() {
        b.data = a.extend(b.data, b.latest);
    }, b.get = function(a) {
        var c = localStorage.getItem(b.STORAGE_KEY), d = c && c[0] ? JSON.parse(c) : [];
        return void 0 !== a && d[a] && (d = [ d[a] ]), d;
    }, b.add = function(a) {
        if (a) {
            var c = b.get(), d = c.concat([ a ]);
            localStorage.setItem(b.STORAGE_KEY, JSON.stringify(d));
        }
    }, b.remove = function(a) {
        if (void 0 !== a) {
            var c = b.get();
            c[0] && (c.splice(a, 1), localStorage.setItem(b.STORAGE_KEY, JSON.stringify(c)));
        } else localStorage.removeItem(b.STORAGE_KEY);
        return b.get();
    }, b.getCollaborators = function(a) {
        var c = b.get(a)[0];
        return c && c.collaborators || b.default.collaborators;
    }, b.updateCollaborators = function(a, c) {
        var d = b.get(), e = d[a];
        c = c || "", e ? (d[a] = b._updateProperty(e, "collaborators", c), localStorage.setItem(b.STORAGE_KEY, JSON.stringify(d))) : (b.default.collaborators = c, 
        localStorage.setItem(b.DEFAULT_COLLABORATOR_KEY, c), b._updateProperty(b.latest, "collaborators", c)), 
        b.update();
    }, b._updateProperty = function(a, b, c) {
        return void 0 !== a[b] && (a[b] = c), a;
    };
}, Namespace.create("xing.jira"), xing.jira.Application = function(a, b, c) {
    "use strict";
    var d, e, f, g, h, i = this, j = xing.core;
    i.initialze = function(b, c) {
        i.layoutName = c && c.layoutName || "", d = new j.Observer(), e = new j.TicketCache(a), 
        h = new j.table.Builder(), g = new j.Markup(), f = new j.I18n().local(), i.tableMap = new j.table.Map(new xing.jira.TableMapCell(), f, i.layoutName), 
        i.addStyle(b), i.collectDataFromDom();
    }, i._getContainer = function(a) {
        return a.hasClass("gm-container") && a || a.parents(".gm-container");
    }, i._clickOutsidePopupHandler = function(b) {
        var c = a(b.target), d = i._getContainer(c);
        d[0] || i._hidePopup();
    }, i._hidePopup = function() {
        a("#gm-popup").remove(), a(document).off("click", i._clickOutsidePopupHandler);
    }, i._updateHTML = function(b) {
        a("#gm-popup").remove();
        var c = i.tableMap.build(e.latest), d = {
            layoutName: i.layoutName
        }, j = h.render(c, d), k = "", l = b.length + 1, m = Math.ceil(l / 2);
        b.forEach(function(a) {
            var b = a.number, e = c.number;
            b !== e && (k += '<li class="gm-output-item">' + h.render(i.tableMap.build(a), d) + g.ticketPanel(f.modal.action.remove) + "</li>");
        }), a("body").append(a('<div id="gm-popup"><section class="gm-container jira-dialog box-shadow">' + g.dialogHeader(f.modal.heading) + '<div class="jira-dialog-content">' + g.pageCounter(f.modal.ticketCount, l, f.modal.pageCount, m) + g.ticketPreview(k, j) + "</div>" + g.dialogFooter(f.modal.select, f.modal.action.print, f.modal.action.cancel) + '</section><div class="aui-blanket gm-print-hidden"></div></div>'));
    }, i.addStyle = function(b) {
        if (!a("#gm-style")[0] && b) {
            var c = a('<style id="gm-style" type="text/css"></style>');
            a(document.head).append(c.html(b));
        }
    }, i.cacheTicketHandler = function() {
        i.update();
        var a = e.latest;
        e.add(a), i._hidePopup(), i._showSuccessMessage();
    }, i._showSuccessMessage = function() {
        a(".aui-message").remove(), window.AJS && AJS.messages.success(".aui-page-header-inner", {
            title: f.messages.ticketCached.title,
            body: f.messages.ticketCached.body
        }), setTimeout(function() {
            a(".aui-message").remove();
        }, 5e3);
    }, i.showPopup = function() {
        a("#gm-popup")[0] || (d.subscribe(this), d.subscribe(e), i.update(e.get()), a("body").on("click", ".js-gm-print-action", function(a) {
            a.preventDefault(), window.print(), e.remove(), i._hidePopup();
        }).on("click", ".js-gm-pick-more", function(a) {
            a.preventDefault(), i.cacheTicketHandler();
        }).on("click", ".js-gm-cancel-action", function(a) {
            a.preventDefault(), i._hidePopup();
        }).on("click", ".js-gm-remove-ticket", function(b) {
            b.preventDefault();
            var c = a(b.target).parents("li"), d = c.index(c);
            e.remove(d), a("#gm-popup .form-body table").eq(d).remove(), i.update(e.get());
        }).on("click", ".gm-change-collaborators", function() {
            var b, c, d = a(".gm-output-list button").index(this) - 1;
            b = a(this).parents(".is-current") ? e.getCollaborators() : e.getCollaborators(d), 
            c = window.prompt(f.modal.collaboratorPrompt, b || ""), null !== c && (e.updateCollaborators(d, c.trimWhitespace()), 
            i.update());
        }));
    }, i.update = function() {
        i._updateHTML(e.get());
    }, i.collectDataFromDom = function() {
        var b = a("#greenhopper-agile-issue-web-panel dd a"), c = new j.Presenter(), f = c.getString(a("#type-val img").attr("alt"));
        e.latest = {
            number: c.getString(a("#key-val").text()),
            description: c.getString(a("#description-val").html()),
            storyPoints: c.getString(a("#customfield_12470-val").text()),
            dueDate: c.getDate(a("#due-date time").attr("datetime")),
            collaborators: e.getCollaborators(),
            type: f,
            typeSelector: c.dashalizer(f),
            reporter: c.getString(a("#reporter-val span").text()),
            created: c.getDate(a("#create-date time").attr("datetime")),
            title: c.getString(a("#summary-val").text()),
            component: c.getString(a("#components-field").text()),
            target: c.getElementText(b)
        }, d.update();
    }, i.initialze(b, c);
}, Namespace.create("xing.jira.helpers"), xing.jira.helpers.Label = function() {
    "use strict";
    var a = this;
    a.NAMESPACE = "aui-lozenge", a.DEFAULT_LABEL_SELECTORS = "aui-lozenge aui-lozenge-subtle", 
    a.DEFAULT_TYPES = {
        bug: "error",
        improvement: "success",
        ...
        var c;
        return b === !1 ? "" : (c = a._filter(b, a.DEFAULT_TYPES), c += a._filter(b, a.AGILE_TYPES), 
        a.DEFAULT_LABEL_SELECTORS + (c ? " " + c : ""));
    }, a._filter = function(b, c) {
        var d = "";
        return Object.keys(c).forEach(function(e) {
            b === e && (d = a.NAMESPACE + "-" + c[e]);
        }), d;
    };
}, Namespace.create("xing.jira"), xing.jira.TableMapCell = function() {
    "use strict";
    var a = this, b = 5;
    a.labelHelper = new xing.jira.helpers.Label(), a.PREFIX = "gm-jira-", a._titleBody = function(b, c) {
        return {
            cell: {
                options: {
                    cssClass: a.PREFIX + c
        ...
        return {
            cell: {
                ...
                body: {
                    options: {
                        cssClass: a.labelHelper.getSelector(b.data.dueDate ? "bug" : !1)
                    },
                    text: b.data.dueDate
                }
            }
